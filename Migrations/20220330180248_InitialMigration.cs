...
namespace NotifyServer.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "NotifyFolderNotifyNotification",
                columns: table => new
                {
                    FoldersId = table.Column<Guid>(type: "uuid", nullable: false),
                    NotificationsListId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotifyFolderNotifyNotification", x => new { x.FoldersId, x.NotificationsListId });
                    table.ForeignKey(
                        name: "FK_NotifyFolderNotifyNotification_Folders_FoldersId",
                        column: x => x.FoldersId,
                        principalTable: "Folders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotifyFolderNotifyNotification_Notifications_NotificationsL~",
                        column: x => x.NotificationsListId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotifyFolderNotifyNotification_NotificationsListId",
                table: "NotifyFolderNotifyNotification",
                column: "NotificationsListId");
